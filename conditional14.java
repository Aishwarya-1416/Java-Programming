...
public class conditional14 {
    public static void main(String[] args) {
        ...
        double baseFee = 0;
        if (membershipTier.equals("Basic")) baseFee = 40;
        else if (membershipTier.equals("Premium")) baseFee = 80;
        else if (membershipTier.equals("Elite")) baseFee = 120;
        else baseFee = 150;

        double contractDiscount = 0;
        if (contractMonths == 6) contractDiscount = 10;
        else if (contractMonths == 12) contractDiscount = 15;
        else if (contractMonths == 24) contractDiscount = 25;

        double accessFee = 0;
        if (accessLevel.equals("Regional")) accessFee = 20;
        else if (accessLevel.equals("Nationwide")) accessFee = 50;
        ...
        String category = "";
        if (membershipTier.equals("Basic")) category = "Budget";
        else if (membershipTier.equals("Premium") && monthlyTotal <= 120) category = "Standard";
        else if (membershipTier.equals("Premium") || membershipTier.equals("Elite")) category = "Premium";
