...
public class conditional9 {
    public static void main(String[] args) {
        ...
        if (type.equals("C-Corp")) {
            if (taxable < 500000) rate = 21;
            else if (taxable <= 1000000) rate = 24;
            else if (taxable <= 2000000) rate = 28;
            else rate = 30;
        } 
        else if (type.equals("S-Corp")) {
            if (taxable < 500000) rate = 20;
            else if (taxable <= 1000000) rate = 25;
            else rate = 28;
        } 
        else if (type.equals("LLC")) {
            if (taxable < 200000) rate = 15;
            else if (taxable <= 500000) rate = 18;
            else rate = 22;
        } 
        else if (type.equals("Partnership")) {
            if (taxable < 300000) rate = 18;
            else if (taxable <= 800000) rate = 22;
            else rate = 26;
        }

        double grossTax = taxable * (rate / 100);
