...
public class conditional13 {
    public static void main(String[] args) {
        ...
        if (studentStatus.equals("Full-Time")) activityFee = 200;
        else if (studentStatus.equals("Part-Time")) activityFee = 100;
        else activityFee = 50;
        ...
        String category = "";
        if (studentStatus.equals("Continuing-Education")) category = "Reduced";
